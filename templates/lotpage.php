      ...
      <div class="lot-item__content">
        <div class="lot-item__left">
          <div class="lot-item__image">
            <img src="<?= $lot_info['image']; ?>" width="730" height="548" alt="<?= htmlspecialchars($lot_info['NAME']); ?>">
          </div>
...
Мин. ставка <span><?= format_price(htmlspecialchars($lot_info['bid_step']), ' р'); ?></span>
            ...
            <form class="lot-item__form" action="lot.php?lot=<?=$lot_info['id']; ?>" method="post" autocomplete="off">
