    ...
    <div class="lot-item__content">
        <div class="lot-item__left">
            <div class="lot-item__image">
                <img src="<?= isset($lot_info['image']) ? htmlspecialchars($lot_info['image']) : ''; ?>" width="730"
                     height="548"
                     alt="<?= isset($lot_info['NAME']) ? htmlspecialchars($lot_info['NAME']) : ''; ?>">
            </div>
            <p class="lot-item__category">Категория:
                <span><?= isset($lot_info['name']) ? htmlspecialchars($lot_info['name']) : ''; ?></span></p>
                ...
                <div class="lot-item__state">
                    ...
                    <div class="lot-item__cost-state">
                        <div class="lot-item__rate">
                            ...
                            <span class="lot-item__cost"><?= isset($lot_info['start_price']) ? format_price(htmlspecialchars($lot_info['start_price']),
                                    '') : ''; ?></span>
                        </div>
                        <div class="lot-item__min-cost">
                            Мин. ставка
                            <span><?= isset($lot_info['bid_step']) ? format_price(htmlspecialchars($lot_info['bid_step']),
                                    ' р') : ''; ?></span>
                        </div>
                    </div>
                    <form class="lot-item__form"
                          action="lot.php?lot=<?= isset($lot_info['id']) ? $lot_info['id'] : ''; ?>" method="post"
                          autocomplete="off">
                ...
                <table class="history__list">
                    <?php foreach ($bids as $bid): ?>
                        <tr class="history__item">
                            ...
                            <td class="history__price"><?= isset($bid['SUM']) ? format_price(htmlspecialchars($bid['SUM']),
                                    ' p') : ''; ?></td>
